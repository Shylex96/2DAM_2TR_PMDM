...
public class MainActivity extends AppCompatActivity
{
    ...
    private List<Color> buildColors()
    {
        ...
        colors.add(new Color(getString(R.string.grey), getResources().getString(R.color.grey)));
        colors.add(new Color(getString(R.string.amber), getResources().getString(R.color.amber)));
